import { Mail, User, MessageSquare, Send, MapPin, Phone, Github, Instagram, Linkedin } from 'lucide-react';
    ...
    <div className="m1axg uo8pm">
        ...
        <form>
          ...
          <div className="rmzo7 flex flex-col sm:flex-row items-center o4ndh rsdjd lnk45 pb094 dark:border-neutral-700">
            <div className="relative w-full">
              ...
              <input type="text" id="hero-input" name="hero-input" className="od5va yzhap xp93d s9dcx block w-full azddh pb094 glhrq k16qo vv6e0 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:text-neutral-400 dark:placeholder-neutral-500" placeholder="Enter your message"/>
            </div>
      ...
      <div className=" gap-12">
        ...
        <div className="space-y-8">
          <div>
            <p className="w4xo0 fd43e dark:text-neutral-400 mb-6">
           
            </p>
          </div>

              <div className="dbe5 yfv61 lnk45 dark:border-neutral-700">
</div>
        ...
        Connect with me 😁
          ...
          <div className="p-6 bg-gradient-to-br from-blue-50/50 to-purple-50/50 dark:from-blue-900/10 dark:to-purple-900/10 rounded-lg border border-gray-200 dark:border-neutral-700">
            ...
            <p className="text-sm text-gray-600 dark:text-neutral-400">
              <span className="font-semibold">Availability:</span> Open for freelance projects and collaborations
            </p>
          </div>
        </div>
