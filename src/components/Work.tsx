        ...
        <div>
          <div className="group relative flex p5sau">
            ...
            <div className="hlt95 l73lz group-last:pb-0">
              ...
              <ul className="rwwei aer8v wc6fu space-y-1.5">
                ...
                <li className="l9qhy w4xo0 fd43e dark:text-neutral-400">
                  Provided detailed documentation and customer support t8g9r GitHub.
                </li>
                <li className="l9qhy w4xo0 fd43e dark:text-neutral-400">
          ...
          <div className="group relative flex p5sau">
            ...
            <div className="hlt95 l73lz group-last:pb-0">
              ...
              <div className="wc6fu">
                <a className="block rsdjd lnk45 pb094 tvbow focus:outline-hidden dark:border-neutral-700" href="#">
                  <div className="relative flex items-center overflow-hidden">
                    <img className="nhovv jmy2q h1r77 absolute inset-0 x1s1r w49qv" src="https://images.unsplash.com/photo-1661956600655-e772b2b97db4?q=80&w=560&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Blog Image"/>
          ...
          <div className="group relative flex p5sau">
            <div className="relative group-last:after:hidden after:absolute after:top-8 after:bottom-2 after:start-3 after:w-px after:-translate-x-[0.5px] after:bg-gray-200 dark:after:bg-neutral-700">
              <div className="relative wzd7f odrp3 flex jkwm1 items-center">
                <svg className="e731n odrp3 c9jt8 dark:text-neutral-200" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                  <path d="M12 12h.01" />
